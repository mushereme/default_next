    ...
    return (
      <div className={className} style={{ display: 'flex', alignItems: 'center' }}>
        <input
          ...
          {...rest}
        />
        {isLastChild && <span style={{color: "#5BA8FF", fontSize: "28px"}}>{separator}</span>}
      </div>
    );
  }
}
...
class OtpInput extends Component {
  ...
  render() {
    ...
    return (
      <div
        style={Object.assign({ display: 'flex', justifyContent: 'center' }, isStyleObject(containerStyle) && containerStyle)}
