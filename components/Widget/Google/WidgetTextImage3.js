    ...
    return rows.map((item, index) => {
        return (
            <div className="relative h-screen" key={index}>
                <div className="relative ml-auto sm:px-6 lg:w-5/12 z-10 h-screen bg-white flex items-center border-l-8 border-gray-600"  >
                ...
                <div className="absolute lg:inset-0 lg:right-0 border-r-8 border-gray-600">
                    <div 
