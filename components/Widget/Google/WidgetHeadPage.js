...
export default function WidgetHeadMain({ myWidget }) {
  ...
  console.log("HeadPage mainConfig", mainConfig);
  console.log("HeadPage header", header);
  console.log("HeadPage rows", rows);
  console.log("HeadPage router", router);
  ...
  return (
    <>
      <Head>
        <title>{mainConfig?.title?.value || ""}</title>
        <meta
          name="description"
          content={mainConfig?.description?.value || ""}
        />
        <meta name="keywords" content={mainConfig?.keywords?.value || ""} />
        ...
        <meta property="og:title" content={mainConfig?.title?.value || ""} />
        <meta
